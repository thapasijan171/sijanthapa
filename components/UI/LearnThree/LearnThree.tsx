    ...
    <ConsoleSecction id='learn_three' border={true} icon={<Tb3DCubeSphere />} branch={"learn_three"}>
      <div
        ...
        <div className={clsx("md:w-[50%] flex flex-col gap-5", "w-full")}>
          ...
          <BodyLine>
            I&apos; started coding and 3D modling on age on 14. I use 3D technologies like Blender and
          ...
          <div className={clsx("py-3 pl-[30px] flex flex-wrap gap-3")}>
            <PrimaryButton event={() => window.open("https://www.github.com/thapasijan171", "_blank")}>
              ThreeJS Journey
            </PrimaryButton>
          </div>
        </div>
