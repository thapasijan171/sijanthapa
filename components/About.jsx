...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
        I'm a Frontend Web Developer based in Pokhara, Nepal. My enthusiasm lies in continuously enhancing my coding abilities and crafting compelling websites. I'm dedicated to self-improvement, constantly working independently to refine my skills. I particularly enjoy constructing Full-Stack clones as part of my learning journey.
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:thapasijan171@gmail.com"
            target="_blank"
            rel="noreferrer"
